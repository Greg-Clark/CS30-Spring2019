...
public:
	...
	~Map();					//Destroys all the dynamically allocated memory in the map.
	Map(const Map& other);	//copy constructor for map
	const Map& operator=(const Map& other);	//assignment operator
